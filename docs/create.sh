...
da run damlc -- docs -o "autogen/CdmTypes.md" -f "Markdown" "../daml/src/Org/Isda/Cdm/EventSpecificationModule.daml" --include-modules "Org.Isda.Cdm.EventSpecificationModule.Types.Classes,Org.Isda.Cdm.EventSpecificationModule.Types.Enums"
